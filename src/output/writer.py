...
def update_index(topic, output_path, started_at, orch_provider, orch_model,
    ...
    if not os.path.exists(index_path):
        with open(index_path, "w", encoding="utf-8") as f:
            ...
            f.write("| Date | Topic | Orchestration | Synthesis | Search | Questions | Searches | Mode | File |\n")
            f.write("|---|---|---|---|---|---|---|---|---|\n")
    ...
    row = f"| {date} | {topic} | {orch} | {synth} | {search_provider} | {question_count} | {search_count} | {mode} | {link} |\n"
