...
- Do not change wording unless a specific coherence defect requires it.
- If in doubt, leave it unchanged.
- Return the full report text — edited or unedited. Nothing else. No preamble, no explanation of changes.
